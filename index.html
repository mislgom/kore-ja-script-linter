        ...
        <section class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
            ...
            <div class="mb-6">
                ...
                <textarea id="korea-senior-script"
                    class="w-full h-64 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary bg-white dark:bg-gray-700 text-gray-800 dark:text-white resize-none"
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" id="analysis-tabs-container">
                    <!-- 탭 1: 한국 배경 확인 -->
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="result-column">
                        <div
                            ...
                            <div id="result-text"
                                class="result-content text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap max-h-96 overflow-y-auto">
