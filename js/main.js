...
function buildStage2Prompt(script) {
    console.log('📝 2차 분석 프롬프트 생성: 정밀 검토 + 놓친 오류 + 점수 산출 (4개 항목)');
    
    return '당신은 조선시대 사극 대본 전문 작가이자 최고급 품질 검수 전문가입니다.\n' +
        '1차 분석에서 놓친 미세한 오류를 찾고, 대본 품질을 정밀 평가해주세요.\n\n' +
        '## 🎯 2차 분석 목적: 정밀 검토 + 놓친 오류 검출 + 점수 산출\n\n' +
        '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n' +
        '## ✅ 검사항목 1: 시간 왜곡 (미세한 부분)\n' +
        '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n' +
        ...
        '- 시대별 제도/문화의 오류\n\n' +
        '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n' +
        '## 📊 점수 산출 (4개 항목, 각 100점 만점)\n' +
        '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n' +
        '### 1. 시니어 적합도 (senior)\n' +
        '- 문장이 짧고 명확한가? (길면 감점)\n' +
        '- 호칭으로 인물 관계가 바로 파악되는가?\n' +
        '- 어려운 한자어 대신 쉬운 표현 사용?\n' +
        ...
        '{\n' +
        '  "errors": [\n' +
        '    {"type": "시간왜곡", "original": "원문", "revised": "수정안 하나만", "reason": "사유 15자 이내", "severity": "medium"},\n' +
        '    {"type": "감정선연결", "original": "원문", "revised": "수정안", "reason": "사유", "severity": "medium"},\n' +
        '    {"type": "대사자연스러움", "original": "원문", "revised": "수정안", "reason": "사유", "severity": "low"},\n' +
        '    {"type": "호칭일관성", "original": "원문", "revised": "수정안", "reason": "사유", "severity": "medium"},\n' +
        '    {"type": "복선회수", "original": "원문", "revised": "수정안", "reason": "사유", "severity": "low"},\n' +
        '    {"type": "역사적사실", "original": "원문", "revised": "수정안", "reason": "사유", "severity": "high"}\n' +
        '  ],\n' +
        '  "scores": {\n' +
        '    "senior": 75,\n' +
        '    "fun": 70,\n' +
        ...
        '      "currentScore": 75,\n' +
        '      "issues": [\n' +
        '        {"location": "S#1", "problem": "문장이 길어 이해 어려움", "solution": "두 문장으로 분리"}\n' +
        '      ]\n' +
        '    }\n' +
        '  ],\n' +
        '  "changePoints": [\n' +
