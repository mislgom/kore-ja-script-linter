...
function buildStage1Prompt(script) {
    ...
    return '당신은 조선시대 사극 대본 전문 검수자입니다. 반드시 오류를 찾아내야 합니다.\n\n' +
        '## 🚨🚨🚨 최우선 필수 검사: 현대 물건/용어 검출 🚨🚨🚨\n\n' +
        '### ⚠️ 아래 단어가 대본에 있으면 무조건 100% 오류입니다! 절대 놓치지 마세요!\n\n' +
        '**필기구**: 펜, 볼펜, 연필, 지우개, 노트 → 붓, 먹, 서책으로 수정\n' +
        '**조명**: 전등, 전구, 형광등, 손전등, 플래시 → 촛불, 등잔, 횃불로 수정\n' +
        '**통신**: 전화, 휴대폰, 핸드폰, 스마트폰, 문자 → 전령, 파발, 서신으로 수정\n' +
        '**교통**: 자동차, 차, 기차, 버스, 택시, 비행기, 지하철 → 가마, 마차, 말로 수정\n' +
        '**가전**: 냉장고, 에어컨, 선풍기, TV, 텔레비전, 라디오, 컴퓨터 → 석빙고, 부채로 수정\n' +
        '**음식**: 커피, 라면, 콜라, 사이다, 햄버거, 피자, 치킨 → 차, 국수, 닭고기로 수정\n' +
        '**의복**: 양복, 정장, 청바지, 티셔츠, 구두, 운동화 → 도포, 한복, 짚신으로 수정\n' +
        '**시설**: 병원, 학교, 경찰서, 은행, 카페, 호텔 → 의원, 서당, 포도청, 전당포로 수정\n' +
        '**직업**: 의사, 경찰, 선생님, 회사원, 기자 → 의원, 포졸, 훈장, 상인으로 수정\n' +
        '**단위**: 미터, 킬로그램, 퍼센트, 원(화폐) → 자, 근, 할, 냥으로 수정\n' +
        '**외래어**: OK, 오케이, 파이팅, 스트레스, 멘탈 → 조선식 표현으로 수정\n\n' +
        '### 📋 전체 시대착오 단어 목록:\n' + rulesString + '\n\n' +
        '## ⛔ 절대 오류로 판정하지 말아야 할 것\n\n' +
        '### 나레이션은 절대 오류가 아닙니다!\n' +
        '- "나레이션:", "NA:", "N:", "내레이션:", "(나레이션)" 으로 시작하는 줄\n' +
        '- 나레이션의 고어체/문어체는 작가 스타일이므로 허용\n\n' +
        '## 📋 추가 검출 항목 (등장인물 대사에서만)\n\n' +
        '### 2. 캐릭터/인물 오류\n' +
        ...
        '## 📝 분석 대상 대본:\n```\n' + script + '\n```\n\n' +
        '## ✅ 응답 규칙 (매우 중요!!!)\n' +
        '1. 위에 나열된 현대 물건/용어(펜, 커피, 병원, 전화 등)가 대본에 있으면 반드시 오류로 검출하세요!\n' +
        '2. 나레이션은 절대 오류로 넣지 마세요!\n' +
        ...
        ']}\n' +
        '```\n\n' +
        '⚠️ 최종 점검: 펜, 커피, 병원, 전화, 시계 등 현대 용어를 모두 검출했는지 다시 확인하세요!';
}
